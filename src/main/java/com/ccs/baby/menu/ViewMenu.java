...
public class ViewMenu {
    ...
    public static JMenu createViewMenu(CrtPanel crtPanel, SwitchPanel switchPanel, Disassembler disassembler, DebugPanel debugPanel) {
        ...
        // Add mnemonics (keyboard shortcuts)
        viewMenu.setMnemonic(86); // Alt + V
        viewStore.setMnemonic(83); // Alt + S
        viewControl.setMnemonic(67); // Alt + C
        viewAccumulator.setMnemonic(65); // Alt + A
        viewDisassembler.setMnemonic(68); // Alt + D
        viewDebugPanel.setMnemonic(66); // Alt + B
